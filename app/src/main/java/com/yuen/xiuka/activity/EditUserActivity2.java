...
public class EditUserActivity2 extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        et_input_info = (EditText) findViewById(R.id.et_input_info2);
    ...
    private void submit() {
        ...
        if (position ==5){
           if ( Long.parseLong(info)>99){
               Toast.makeText(this, "年龄不能超过100", Toast.LENGTH_SHORT).show();
               return;
           }else if ( Long.parseLong(info)<0){
               Toast.makeText(this, "年龄不能超过100", Toast.LENGTH_SHORT).show();
               return;
           }
