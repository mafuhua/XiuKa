 ...
 * 此类还依赖两个工具类 PropsUtil MyFileFilter
 * @since  1.0
 */
...
public class FileUtil {
   ...
   * @since  1.0
   */
  public static File[] listAll(File file,MyFileFilter filter) {
    ArrayList list = new ArrayList();
    File[] files;
    if (!file.exists() || file.isFile()) {
      return null;
   ...
   * @param file 目录
   */
  private static void list(ArrayList list, File file,MyFileFilter filter) {
