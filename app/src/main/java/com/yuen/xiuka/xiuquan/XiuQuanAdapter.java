...
// 分享时Notification的图标和文字  2.5.9以后的版本不调用此方法
     ...
     //   oks.setTitleUrl("http://sharesdk.cn");
        ...
        oks.setImagePath("/storage/emulated/0/imagcacahe/0.jpg");//确保SDcard下面存在此张图片
    ...
    //    oks.setUrl("http://sharesdk.cn");
        ...
        oks.setSiteUrl("http://sharesdk4545.cn");
...
// 启动分享GUI
        ...
        oks.setTitle("我要上班喽");
        // titleUrl是标题的网络链接，仅在人人网和QQ空间使用
        oks.setTitleUrl("http://www.baidu.com/");// 自己公司主页（分析文章的url）
        // text是分享文本，所有平台都需要这个字段
        oks.setText("服务上班一族，博您闲暇时一笑~顺便提供点儿与企业服务、工作生活相关的咨询与服务");
        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
        oks.setImagePath("/storage/emulated/0/imagcacahe/0.jpg");
        // oks.setImageUrl("http://139.196.50.80/636gongshe/uploads/icon.png");
        oks.setImageUrl("http://139.196.50.80/636gongshe/uploads/sharelogo.jpg");
        // url仅在微信（包括好友和朋友圈）中使用
