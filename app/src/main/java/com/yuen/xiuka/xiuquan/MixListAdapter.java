...
public class MixListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (info.data.size() == 1){
            ...
            float height = 0.0f;
            if (w > h){
                width = activity.getWindowManager().getDefaultDisplay().getWidth() - dip2px(130);
            }else if(w < h){
            ...
            float width = ( activity.getWindowManager().getDefaultDisplay().getWidth() - dip2px(80) - dip2px(2))/3;
